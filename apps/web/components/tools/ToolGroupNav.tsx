...
import { getToolGroupForTool, getToolSpecById, toolGroups } from '@focus/shared';
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
                {activeGroup.title} · {activeGroup.tagline}
              </p>
            </div>
          </div>
          <span className="text-[10px] sm:text-xs font-semibold text-purple-600 dark:text-purple-300 px-2 py-1 rounded-full bg-white/60 dark:bg-gray-800/60 border border-purple-200 dark:border-purple-600">
            {relatedTools.length} tools
          </span>
        </div>
