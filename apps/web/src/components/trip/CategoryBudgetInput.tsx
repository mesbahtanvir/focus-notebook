...
const categoryIcons: Record<ExpenseCategory, React.ReactNode> = {
  airfare: <Plane className="w-5 h-5" />,
  accommodation: <Home className="w-5 h-5" />,
  food: <Utensils className="w-5 h-5" />,
  transportation: <Car className="w-5 h-5" />,
  activities: <PartyPopper className="w-5 h-5" />,
  shopping: <ShoppingBag className="w-5 h-5" />,
  misc: <Package className="w-5 h-5" />,
...
const categoryColors: Record<ExpenseCategory, string> = {
  airfare: 'text-blue-600 dark:text-blue-400',
  accommodation: 'text-purple-600 dark:text-purple-400',
  food: 'text-orange-600 dark:text-orange-400',
  transportation: 'text-green-600 dark:text-green-400',
  activities: 'text-yellow-600 dark:text-yellow-400',
  shopping: 'text-pink-600 dark:text-pink-400',
  misc: 'text-red-600 dark:text-red-400',
