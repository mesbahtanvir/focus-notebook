...
const customJestConfig = {
  ...
  moduleNameMapper: {
    '^@/(.*)$': '<rootDir>/$1',
    '^@focus/shared$': '<rootDir>/../packages/shared/src/index.ts',
    '^@focus/shared/(.*)$': '<rootDir>/../packages/shared/src/$1',
  },
  transform: {
  ...
  testPathIgnorePatterns: [
    ...
    '<rootDir>/__tests__/utils/builders/', // Ignore builder files (not tests)
    '<rootDir>/__tests__/utils/testHelpers', // Ignore test helpers (not tests)
  ],
