...
exports.categorizeLowConfidenceTransaction = categorizeLowConfidenceTransaction;
...
// ============================================================================
function categorizeTransaction(merchant, description, plaidCategories, isPremium) {
...
// ============================================================================
async function categorizeLowConfidenceTransaction(merchant, description, amount) {
    try {
...
// ============================================================================
function mapToBaseCategory(premiumCategory) {
    const mapping = {
